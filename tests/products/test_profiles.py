...
class TestSentinel2L2A:
    ...
    def test_bands_exist(self, profile):
        ...
        expected_bands = [
            'blue', 'green', 'red', 'nir',  # 10m bands
            'red_edge_1', 'red_edge_2', 'red_edge_3',  # 20m red edge
            'nir_narrow', 'swir_1', 'swir_2'  # 20m NIR/SWIR
        ]
...
class TestLandsat8L2:
    ...
    def test_bands_exist(self, profile):
        """Test that all expected bands exist"""
        expected_bands = [
            'coastal', 'blue', 'green', 'red', 'nir', 'swir_1', 'swir_2'
        ]
        for band_name in expected_bands:
            assert band_name in profile.bands
